...
from optimx.tracking.utils.exceptions import ExceptionWithMessage, InvalidInput
...
class Serializer(abc.ABC):
    ...
    def decompress(cls, data: bytes) -> bytes:
        ...
        codec = MAGIC_COMPRESSION_PREFIX_MAP.get(
            data[:2], CompressionCodec.uncompressed
        )
