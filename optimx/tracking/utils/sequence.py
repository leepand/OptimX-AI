...
from optimx.tracking.utils.frames import reorder_columns
...
class Sequence:
    ...
    def set_stream(self, name, callback):
        if callback is None:
            ...
            self.stream_send = lambda record: callback(
                {"field_name": name, "record": record}
            )
    ...
    def append(self, **kwargs):
        ...
        record = {"idx": idx, "timestamp": timestamp}
