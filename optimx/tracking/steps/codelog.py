...
from optimx.tracking import Run
from ..opts import options
from ..run import StepsType, normalize_steps
...
def get_func_code_ext(func, args=None, kwargs=None):
    ...
    if isinstance(func, functools.partial):
        return get_func_code_ext(
            func.func, args=args + list(func.args), kwargs=kwargs | func.keywords
        )
    else:
