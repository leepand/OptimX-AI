...
from optimx.assets.versioning.major_minor import MajorMinorAssetsVersioningSystem
from optimx.assets.versioning.simple_date import SimpleDateAssetsVersioningSystem
from optimx.assets.versioning.versioning import AssetsVersioningSystem
...
class AssetSpec:
    ...
    def __init__(
        ...
        versioning = (
            versioning
            or os.environ.get("OPTIMX_ASSETS_VERSIONING_SYSTEM")
            or "major_minor"
        )
