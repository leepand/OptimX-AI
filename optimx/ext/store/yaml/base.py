...
from optimx.utils.loadobj import load_obj
...
_DEFAULT_PACKAGES = ["optimx.ext.store.yaml.", "optimx.ext.store.", ""]
...
class AbstractDataSet(abc.ABC):
    ...
    ::
        ...
        >>> import pandas as pd
        >>> from optimx.io import AbstractDataSet
        >>>
        >>>
...
def _load_obj(class_path: str) -> Optional[object]:
    ...
    #                 `__all__` attribute -- either because it's a custom or a optimx.io dataset
    ...
    try:
        ...
        if available_classes and class_name in available_classes:
            raise DataSetError(
                ...
                f"https://optimx.readthedocs.io/en/stable/"
                f"optimx_project_setup/dependencies.html"
            ) from exc
        return None
    ...
    def __init__(
        ...
        Args:
            ...
            version: If specified, should be an instance of
                ``optimx.io.core.Version``. If its ``load`` attribute is
